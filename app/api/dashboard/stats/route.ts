  ...
  try {
    ...
    if (isBuildTime()) {
      return NextResponse.json({
        customers: { total: 0, currentMonth: 0, lastMonth: 0, growthRate: 0, totalContractAmount: 0, averageContractAmount: 0, customersWithContracts: 0, totalAnnualRevenue: 0, byIndustry: {} },
        tasks: { total: 0, completed: 0, pending: 0, inProgress: 0, high: 0, medium: 0, low: 0 },
        leads: { total: 0, new: 0, contacted: 0, qualified: 0, averageScore: 0 },
        opportunities: { total: 0, totalValue: 0, averageValue: 0, byStage: { qualification: 0, proposal: 0, negotiation: 0, closed: 0 } },
        monthlyData: [],
        monthlyRevenue: [],
        recentActivities: [],
        taskReminders: { overdue: [], today: [], upcoming: [] }
      })
    }
